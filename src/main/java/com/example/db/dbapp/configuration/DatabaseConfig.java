...
public class DatabaseConfig extends AbstractCloudConfig {
	...
	@Value("${vcap.services.hdb-scm.credentials.user}")
	private String username;

	@Value("${vcap.services.hdb-scm.credentials.password}")
	private String password;

	@Value("${vcap.services.hdb-scm.credentials.url}")
	private String hostname;

	@Value("${vcap.services.hdb-scm.credentials.port}")
	private String port;

	@Value("${vcap.services.hdb-scm.credentials.schema}")
    ...
    public DataSource dataSource() {
       ...
       DataSource myConnection =  DataSourceBuilder.create()
        ...
        cloudFoundryDataSourceConfigLogger.info("Detected DB name is : " + this.schemaname);
